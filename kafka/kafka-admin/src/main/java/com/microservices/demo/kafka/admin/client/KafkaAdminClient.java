...
public class KafkaAdminClient {
    ...
    private <T> CreateTopicsResult doCreateTopics(RetryContext retryContext) {
    ...
    private void sleep(Long sleepTimeMs) {
        try {
            ...
            throw new KafkaClientException("Error while sleeping for waiting new topics to be created!!");
        }
    }
    ...
    private <T> Collection<TopicListing> doGetTopics(RetryContext retryContext) throws ExecutionException, InterruptedException {
